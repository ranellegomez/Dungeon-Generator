...
public class Tileset {
    public static final TETile COMPANION =
            new TETile('狗', Color.white, Color.black, "your companion");
    public static final TETile WALL =
            new TETile('#', new Color(216, 128, 128), Color.darkGray,
                       "a wall");
    public static final TETile FLOOR =
            new TETile('·', new Color(128, 192, 128), Color.black,
                       "the floor");
    public static final TETile NOTHING =
            new TETile(' ', Color.black, Color.black, "black space");
    ...
    public static void setAvatarName(String name) {
        AVATAR = new TETile('⟗', Color.white, Color.black, name);
    }
}
